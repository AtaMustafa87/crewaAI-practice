...
- Modify `src/name_of_flow/config/agents.yaml` to define your agents
- Modify `src/name_of_flow/config/tasks.yaml` to define your tasks
- Modify `src/name_of_flow/crew.py` to add your own logic, tools and specific args
